...
(async () => {
  console.log('🎬 Recording Nest Image-to-3D (improved 4-phase)...');
  ...
  const imagePath = path.join(__dirname, 'user-image-nest.jpg');
